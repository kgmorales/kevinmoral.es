...
export default function Hero({ heroData }) {
  ...
  return (
    <div className="w-lg mx-auto my-10 flex flex-col gap-10 md:flex-row md:items-stretch">
      {/* Left side: portrait */}
      <div className="relative flex justify-center rounded-[16px] shadow-normal sm:w-full md:w-1/2 lg:w-3/4">
        <HeroPortrait />
      </div>
      ...
      <div className="flex flex-col justify-between gap-6 self-stretch md:w-1/2">
        ...
        {/* This container now includes Tailwind transition classes */}
        <AnimatePresence exitBeforeEnter>
          <div className="flex min-h-[280px] flex-col transition duration-500 ease-in-out">
            {showScoreboard ? (
